...
def datafr():
    df = pd.read_csv(r"C:/Users/LENOVO/Downloads/Project4 Airbnb/airbnb.csv")
    return df
...
if select == "Home":
    image1= Image.open(r"C:/Users/LENOVO/Downloads/Project4 Airbnb/image.png")
    st.image(image1)
...
if select == "Data Exploration":
    ...
    with tab1:
        ...
        with col1:
            ...
            fig_bar = px.bar(df_bar, x="property_type", y="price", title="PRICE FOR PROPERTY TYPES",
                 hover_data= ["number_of_reviews", "review_scores"], width=600, height=500,
        ...
        with col2:
            ...
            fig_pie = px.pie(df_pie, names= "host_response_time", values= "price",
                             hover_data=["bedrooms"], color_discrete_sequence=px.colors.sequential.Redor,
    ...
    with tab2:
        ...
        def datafr():
            df_a = pd.read_csv(r"C:/Users/LENOVO/Downloads/Project4 Airbnb/airbnb.csv")
            return df_a
        ...
        with col1:
            country = st.selectbox("Select the Country_avl", df["country"].unique())

            df1= df[df["country"] == country]
            df1.reset_index(drop= True, inplace= True)

            property_ty = st.selectbox("Select the Property Type_avl", df["property_type"].unique())
            ...
            df_a_sunb_30 = px.sunburst(df2, path=["room_type", "bed_type", "is_location_exact"],
                                       ...
                                       title= "AVAILABILITY_30", color_discrete_sequence=px.colors.sequential.Redor_r)
        ...
        with col2:
            ...
            df_a_sunb_60 = px.sunburst(df2, path=["room_type", "bed_type", "is_location_exact"],
                                       ...
                                       title= "AVAILABILITY_60", color_discrete_sequence=px.colors.sequential.Peach_r)
        ...
        with col1:
            df_a_sunb_90 = px.sunburst(df2, path=["room_type", "bed_type", "is_location_exact"],
                            ...
                            title= "AVAILABILITY_90", color_discrete_sequence=px.colors.sequential.Aggrnyl)
        ...
        with col2:
            df_a_sunb_365 = px.sunburst(df2, path=["room_type", "bed_type", "is_location_exact"],
                        ...
                        title= "AVAILABILITY_365", color_discrete_sequence=px.colors.sequential.Aggrnyl_r )
            
            st.plotly_chart(df_a_sunb_365)

        room_ty_a = st.selectbox("Select the Room Type_avl", df2["room_type"].unique())
        ...
        fig_df_mul_bar_a = px.bar(df3_a, x='host_response_time', y=['availability_30', 'availability_60', 'availability_90', "availability_365"], 
